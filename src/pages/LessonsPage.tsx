        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {googleConnected && (
            <button
              ...
              className="flex items-center gap-2 bg-(--bg-card) border border-(--border) text-(--text-2) font-medium rounded-lg px-4 py-2 text-sm hover:border-(--border-hover) transition-colors"
            >
              <svg
                width="14"
                height="14"
