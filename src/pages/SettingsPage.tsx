...
export default function SettingsPage() {
  ...
  const handleClearAll = async () => {
    if (
      !confirm(
        "Sigur vrei să ștergi TOATE datele? Această acțiune nu poate fi anulată!",
      )
    )
      return;
    if (
      !confirm(
        "Ești absolut sigur? Toate lecțiile, studenții și plățile vor fi șterse!",
      )
    )
      return;
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-(--text-2) text-sm mt-1">
            Gestionează profilul și preferințele
          </p>
        </div>
        ...
        <div className="mt-6 bg-red-400/5 border border-red-400/20 rounded-xl p-5">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-(--text-2) text-xs mt-0.5">
                Acțiune ireversibilă — șterge tot
              </p>
            </div>
            <button
